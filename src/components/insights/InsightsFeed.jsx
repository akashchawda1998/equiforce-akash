...
const InsightsFeed = () => {
  ...
  const insightsData = [
    {
      id: 1,
      type: "podcast",
      title: "TSG Time Episode 41 - Leadership Journey: From Operations to Entrepreneurship",
      description:
  ...
  return (
    <div className="space-y-12">
      ...
      {featured && (
        <div
          className="bg-gradient-to-br from-[#000E24] to-[#0a1f3d] rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow"
          data-aos="fade-up"
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            ...
            <button
              ...
              className="relative w-full h-56 md:h-full min-h-[260px] overflow-hidden group cursor-pointer"
            >
              <img
                src={featured.image}
                alt={featured.title}
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative w-16 h-16 md:w-20 md:h-20 flex items-center justify-center">
                  ...
                  >
                    <FiPlay className="text-white text-2xl md:text-3xl ml-0.5" />
                  </span>
                </div>
              </div>
            </button>
            ...
            {/* Content */}
            <div className="p-8 md:p-10 flex flex-col justify-between text-white">
              <div>
                <div className="flex items-center gap-2 mb-3">
                  <span className="bg-[#d97706] text-white px-3 py-1 rounded-full text-xs font-semibold uppercase">
                    Featured
                  </span>
                ...
                <p className="text-gray-300 mb-6 leading-relaxed text-base line-clamp-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {featured.topics.map((topic, idx) => (
                    <span
                      key={idx}
                      className="bg-white/10 text-white px-3 py-1 rounded-lg text-sm font-medium hover:bg-white/20 transition"
                    >
                      {topic}
                    </span>
                  ))}
                ...
                <div className="flex flex-wrap items-center gap-6 text-sm text-gray-300 pt-4 border-t border-white/10">
                  <div className="flex items-center gap-2">
                    <FiUser className="text-[#d97706]" />
                    <div>
                      <p className="font-semibold text-white">{featured.author}</p>
                      <p className="text-xs">{featured.authorRole}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
        ...
        >
          ...
          >
            ...
            <button
              ...
              className="absolute top-3 right-3 z-10 w-10 h-10 rounded-full bg-black/60 hover:bg-black/80
            ...
            {/* Video Info */}
            <div className="bg-[#000E24] p-6 overflow-y-auto">
