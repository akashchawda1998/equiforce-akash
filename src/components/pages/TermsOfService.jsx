      ...
      <section className="w-full px-4 md:px-10 lg:px-20 py-12">
        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10 space-y-8 text-gray-700 leading-relaxed text-sm md:text-base">
          ...
          <div>
            ...
            <p>
              By using our website, you affirm that you are at least 18 years
              old or have the legal consent of a parent or guardian to use our
              services.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              changes have been made constitutes acceptance of the revised
              Terms.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                interferes with the functionality of the website.
              </li>
              <li>
                Unauthorized use of our website, including hacking or data
          ...
          <div>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                We are not liable for any losses caused by unauthorized use of
                your account.
              </li>
            </ul>
          </div>
